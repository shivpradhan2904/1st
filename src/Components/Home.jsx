  ...
  return (
    <div
      ...
      <div className="absolute flex flex-col gradient-transition3 h-full w-full">
        <div className="md:relative md:flex-grow md:grid lg:flex grid grid-cols-1 md:mx-6 ml-[1.1rem] items-center md:mb-9 justify-between mt-[3rem] md:mt-[5rem] py-4 md:py-0 mx-4 pr-1 rounded-3xl bg-[#011b21] hover:scale-[1.02] hover:shadow-xl hover:shadow-[#203632] transition-all duration-300 ease-in-out">
          <div className="text-white ml-7 md:ml-10">
            <h1 className="text-4xl font-mono inline-block text-[#00FFFF] md:text-6xl sm:text-4xl xs:text-3xl">
            ...
            <p className="text-[14px] md:mt-5 mt-3 w-[19rem] pr-5 md:pr-0 sm:[17rem] md:text-xl md:w-[40rem] sm:text-base sm:w-[20rem] xs:text-sm xs:w-[15rem]">
