  ...
  return (
    <div
      ...
      <div className="absolute flex flex-col gradient-transition3 h-full w-full">
        <div className="md:relative md:flex-grow md:grid lg:flex grid grid-cols-1 md:mx-6 ml-[1.1rem] items-center md:mb-9 justify-between mt-[1rem] md:mt-[5rem] py-6 md:py-0 mx-4 pr-1 rounded-3xl bg-[#011b21] hover:scale-[1.02] hover:shadow-xl hover:shadow-[#203632] transition-all duration-300 ease-in-out">
